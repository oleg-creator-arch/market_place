...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20201118_grundfos_0a43d35f40d01b965074_20210916125222_archive.zip';
	const ARCHIVE_SIZE		 = '77454597';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '0a43d35-16125222';
    const SECONDARY_PACKAGE_HASH = '7ec0153-16125222';
	const VERSION			 = '1.4.3';
