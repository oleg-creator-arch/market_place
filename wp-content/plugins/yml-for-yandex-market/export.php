		 ...
		 <tr>
			...
			<td class="overalldesc">
				<select name="yfym_vat" id="yfym_vat">
					...
					<option value="NO_VAT" <?php selected($yfym_vat, 'NO_VAT'); ?>><?php _e('No VAT', 'yfym'); ?> (NO_VAT)</option>
					<option value="VAT_0" <?php selected($yfym_vat, 'VAT_0'); ?>>0% (VAT_0)</option>
					<option value="VAT_10" <?php selected($yfym_vat, 'VAT_10'); ?>>10% (VAT_10)</option>
					<option value="VAT_10_110" <?php selected($yfym_vat, 'VAT_10_110'); ?>>10/110 (VAT_10_110)</option>	
					<option value="VAT_18" <?php selected($yfym_vat, 'VAT_18'); ?>>18% (VAT_18)</option>
					<option value="VAT_18_118" <?php selected($yfym_vat, 'VAT_18_118'); ?>>18/118 (VAT_18_118)</option>
					<option value="VAT_20" <?php selected($yfym_vat, 'VAT_20'); ?>>20% (VAT_20)</option>
					<option value="VAT_20_120" <?php selected($yfym_vat, 'VAT_20_120'); ?>>20/120 (VAT_20_120)</option>
					</optgroup>
				</select><br />
